...
### Phase 2 — Collection `bookings` chuẩn (quyết định #1: một record) - CHƯA LÀM
...
### Phase 3 — Endpoint hẹp, validate server-side (quyết định #8) - CHƯA LÀM
...
### Phase 4 — SePay Payment Gateway / VietQR (quyết định #3, #9) - CHƯA LÀM
...
### Phase 5 — Scheduler (quyết định #5, #7) - CHƯA LÀM
...
### Phase 7 — Notification transactional (quyết định #14) - CHƯA LÀM
...
### Phase 8 — Vòng đời Stream chat (quyết định #13; SDK v9.x — có addMembers/removeMembers/updatePartial frozen) - CHƯA LÀM
...
### Phase 9 — Gỡ giả lập matchmaking (quyết định #10; phase rủi ro nhất) - CHƯA LÀM
...
### Phase 10 — Analytics trung thực - CHƯA LÀM
